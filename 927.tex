...
\begin{itemize}
	...
	notions mathématique bien connu (\bsc{Syracuse}, Conjecture de 
	\bsc{Collatz}).
...
%    problème d'effets de bord dans la programmation impérative.
...
%    interprétation abstraite,  qui permet de prouver l'abscence de 
%certain type de bug.
