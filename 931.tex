...
%   mémoisation est un sous cas de la pro dynamique.
...
%   3) la mémoization évite le problème précédent, mais induit un coup mémoire plus grand, limite la parallélisation et augmente les coup d'accès mémoire.
