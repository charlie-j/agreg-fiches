...
\begin{itemize}
    ...
    \item[-] \input{dev/cook}
    \item[+] \temporary{Indécidabilité de l'arrêt et applications à quelques problèmes indécidables} ref ?
    \item[++] \temporary{Équivalence entre deux variantes des machines de Turing} ref ?
