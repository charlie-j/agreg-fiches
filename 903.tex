...
\begin{itemize}
    ...
    \item Donner quelques applications non-triviales du tri ? % recherche par dichotomie, pair d'entier les plus proches, frequence la plus eleve dans une liste, selection du k-ieme element, pair de point du plan les plus proches, enveloppe convexes
