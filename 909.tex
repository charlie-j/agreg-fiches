...
\item Théorème de \bsc{Kleene}, connaître/mentionner les constructions pour la preuve (parmis \bsc{Thompson}, \bsc{Glushkov}, \bsc{Antimirov}, \bsc{McNaughton-Yamada}, \bsc{Brzozoswky-McCluskey}).
\end{itemize}
...
% Thompson => O(|E|^2)
% Gluchkov => exactement |E| +1 état et au plusO(|E|^2) transitions
