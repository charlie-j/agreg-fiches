...
%machine s'arrete, on a des problèmes...
    ...
    \item Quelles est la classe de machines de \bsc{Turing} équivalent aux fonctions récursives primitives ? % les machines en temps primitifs récursifs. Il suffit de mettre un timeout. Tout ce qui est calculable avec une complexité pas trop grande est en fait récursif primitif via time out !
...
\item À quoi sert la fonction d'\bsc{Ackermann} ? Quelle partie de sa 
construction la rend non primitive ?
% à montrer les limites des fonctions récursives primitives, qui 
%n'est pas équivalent à Turing. Double récursion imbriqué.
...
% def sans shema recursif, que somme et produit borné. ELEMENTARY. la 
